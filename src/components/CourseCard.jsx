      ...
      >
        ...
        <div className="relative overflow-hidden flex-shrink-0" style={{ aspectRatio: '16/9' }}>
          ...
          <div
            ...
            style={{
              background: 'linear-gradient(to top, rgba(0,0,10,0.92) 0%, rgba(0,0,10,0.3) 55%, transparent 100%)',
            }}
          />
        ...
        <div className="flex flex-col flex-1 p-5">
          ...
          <div className="flex items-center justify-between mb-3">
            ...
            <ArrowUpRight
              className="w-4 h-4 opacity-0 group-hover:opacity-50 transition-all duration-300
          ...
          {/* Title */}
          <h3
            className="font-display font-black text-sm leading-snug mb-2 line-clamp-2
