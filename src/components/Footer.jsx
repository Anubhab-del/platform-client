...
export default function Footer() {
  return (
    <footer
      style={{
        background: 'linear-gradient(to bottom, #00000a, #000008)',
    ...
    >
      ...
      >
        <div
          ...
          style={{
            background:
              'radial-gradient(ellipse 60% 100% at 50% 50%, rgba(99,102,241,0.1), transparent)',
          }}
        />
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <Link
              ...
              className="group flex items-center gap-3 px-8 py-4 rounded-2xl
                          font-black text-base text-white flex-shrink-0
                          transition-all duration-300 overflow-hidden relative"
              style={{
                background:
                  'linear-gradient(135deg, #818cf8 -20%, #6366f1 40%, #4338ca 100%)',
                boxShadow:
                  '0 0 0 1px rgba(255,255,255,0.15) inset, 0 0 40px rgba(99,102,241,0.5), 0 8px 24px rgba(99,102,241,0.4)',
                letterSpacing: '-0.015em',
              }}
              onMouseEnter={(e) => {
                e.currentTarget.style.transform = 'translateY(-2px)';
                e.currentTarget.style.boxShadow =
                  '0 0 0 1px rgba(255,255,255,0.2) inset, 0 0 60px rgba(99,102,241,0.7), 0 16px 40px rgba(99,102,241,0.55)';
              }}
              onMouseLeave={(e) => {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10 lg:gap-16">
          ...
          <div className="col-span-2 md:col-span-1">
            <Link to="/" className="flex items-center gap-3 mb-7 group w-fit">
              <div
                className="w-11 h-11 rounded-2xl flex items-center justify-center
                            flex-shrink-0 transition-all duration-400 group-hover:scale-110"
                style={{
            ...
            <p
              className="text-sm leading-relaxed max-w-[200px] mb-8"
