...
import {
  ...
  LayoutDashboard, LogIn, LogOut, UserPlus,
    ...
    <>
      ...
      >
        <div className="flex items-center justify-center gap-2">
          ...
          <span>Groq AI assistant is now live — ask anything, learn faster</span>
          <Sparkles className="w-3 h-3 text-yellow-300" />
        </div>
      </div>
      ...
      <header
        ...
        style={{
          ...
          WebkitBackdropFilter: `blur(${scrolled ? 40 : 16}px) saturate(200%)`,
          borderBottom: `1px solid rgba(255,255,255,${scrolled ? 0.08 : 0.04})`,
          boxShadow: scrolled
            ? '0 1px 0 rgba(255,255,255,0.05) inset, 0 20px 60px rgba(0,0,0,0.8)'
            : 'none',
        }}
      >
          ...
          <div className="flex items-center h-[70px] gap-8">
            ...
            <div className="hidden md:flex items-center gap-3 flex-shrink-0">
              {user ? (
                <div className="relative">
                  <button
                    ...
                    style={{
                      ...
                      boxShadow: profileOpen ? '0 0 30px rgba(99,102,241,0.2)' : 'none',
                    }}
                  >
                    <div className="relative flex-shrink-0">
                      <img
                        ...
                        style={{ boxShadow: '0 0 0 2px rgba(99,102,241,0.6), 0 0 16px rgba(99,102,241,0.3)' }}
                      />
                      <div
                    ...
                    <>
                      ...
                      <div
                        ...
                        style={{
                          ...
                          boxShadow: '0 0 0 1px rgba(255,255,255,0.05) inset, 0 0 60px rgba(99,102,241,0.12), 0 40px 80px rgba(0,0,0,0.8)',
                        }}
                      >
                        <div
                        ...
                        >
                          ...
                          <div className="relative flex items-center gap-3">
                            <img
                              ...
                              style={{ boxShadow: '0 0 0 2px rgba(99,102,241,0.6), 0 0 24px rgba(99,102,241,0.4)' }}
                            />
                ...
                <>
                  <Link to="/login" className="btn-ghost px-5 text-sm">Sign in</Link>
            ...
            <button
              ...
              style={{
                background: mobileOpen ? 'rgba(99,102,241,0.18)' : 'rgba(255,255,255,0.05)',
                border: `1px solid ${mobileOpen ? 'rgba(99,102,241,0.35)' : 'rgba(255,255,255,0.1)'}`,
              }}
            >
                ...
                <>
                  ...
                  >
                    <img
                      ...
                      style={{ boxShadow: '0 0 0 2px rgba(99,102,241,0.5), 0 0 16px rgba(99,102,241,0.3)' }}
                    />
                    <div className="min-w-0">
